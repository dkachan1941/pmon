"""
Django settings for pricemon project.
...
import sys
sys.path.append("/home/work/django/d3/pricemon/")
...
SECRET_KEY = '@qt66n7xf#es)9l#kgu8ae(t6)r!buc+6&io&gdr05^h+(%@oi'
...
TEMPLATE_DIRS = (
    os.path.abspath(__file__).split('pricemon')[0]+'/pricemon/templates/',
